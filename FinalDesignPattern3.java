...
public class ByeFelishaMainProgram{
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException,InterruptedException, NoSuchElementException {
        ...
        //IMPLEMENTING MVC
        Model model = readUserLicense();
        View view = new View();


        Controller controller = new Controller(model , view);
        controller.updateView();
        controller.SetUserAgreement("Proceeding to Main Menu...");
    ...
    private static Model readUserLicense(){
        Model model = new Model();
        model.SetUserAgreement("Loading Program\n");
        return model;
    }
...
class Controller{
    ...
    public String GetUserAgreement() {
        ...
        return model.GetUserAgreement();
    }

    public void updateView() {
        view.printUserAgreement(model.GetUserAgreement());
    }

}

class View{
    public void printUserAgreement(String s) {
