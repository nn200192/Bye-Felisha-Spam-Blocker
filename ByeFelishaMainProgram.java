...
class UseCase2 {
	...
	public void Prompt() {
        ...
        // take out, put in class, call it once
	public void Felisha() {
		System.out.println("  		     ██╗██████╗ ██╗   ██╗███████╗    ███████╗███████╗██╗     ██╗███████╗██╗  ██╗ █████╗ ██╗██╗██╗                   \r\n" +
				"                    ██╔�?██╔�?�?██╗╚██╗ ██╔�?██╔�?�?�?�?�?    ██╔�?�?�?�?�?██╔�?�?�?�?�?██║     ██║██╔�?�?�?�?�?██║  ██║██╔�?�?██╗██║██║╚██╗                  \r\n" +
				"                    ██║ ██████╔�? ╚████╔�? █████╗      █████╗  █████╗  ██║     ██║███████╗███████║███████║██║██║ ██║                  \r\n" +
...
class Command 
{   
    // call function in interace
    // define function somewhere else
    
    public interface menu_object 
    { 
        // call function here
        // define function in each class?
    
    }  // END INTERFACE-COMMAND
    
    public void choose_object 
            // method to implement for each class
    {
